...
- **Global scope**: `/Users/shivamsinghal/projects/bandwidth-monitor/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/shivamsinghal/projects/bandwidth-monitor/.claude/notes/`)
...
2. Glob `/Users/shivamsinghal/projects/bandwidth-monitor/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/shivamsinghal/projects/bandwidth-monitor/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/shivamsinghal/projects/bandwidth-monitor/.claude/notes/` — works in any directory
