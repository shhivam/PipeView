...
- Usage: Reference from command with `@/Users/shivamsinghal/projects/bandwidth-monitor/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/shivamsinghal/projects/bandwidth-monitor/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/shivamsinghal/projects/bandwidth-monitor/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
