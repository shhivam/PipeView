...
**Domain:** macOS menu bar bandwidth monitor (native Swift app)
...
Use a hybrid architecture where AppKit manages the menu bar status item and SwiftUI renders the popover content. This is the standard pattern for menu bar apps that need to frequently update status bar text.

**Why hybrid instead of pure SwiftUI MenuBarExtra:**
...
**If targeting macOS 13+ (recommended):**
...
---
*Stack research for: macOS menu bar bandwidth monitor*
*Researched: 2026-03-23*
